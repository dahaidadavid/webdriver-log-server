...
module.exports = function(app) {
  ...
  rootRouter
    ...
    .del('/wd/hub/session/:sessionId', controllers.session.delSession)
     //获取ios设备log日志的api
		.post('/wd/hub/logs/start',controllers.session.startLog)
		.post('/wd/hub/logs/stop',controllers.session.stopLog)
		.post('/wd/hub/logs/getlogs',controllers.session.getLogs)
		.post('/wd/hub/logs/getCrashs',controllers.session.getCrashs);
